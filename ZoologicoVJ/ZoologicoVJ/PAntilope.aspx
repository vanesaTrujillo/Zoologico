<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PAntilope.aspx.cs" Inherits="ZoologicoVJ.PAntilope" %>
...
<body>
    ...
    <div style="font-family: 'Berlin Sans FB'; font-size: 57px; color: #008000; height: 59px; clip: rect(auto, 10px, auto, 10px); text-align: center;">
        ...
        <asp:ImageButton ID="ImageButton1" runat="server" Height="229px" ImageAlign="TextTop" ImageUrl="~/img/antilope.jpg" style="margin-top: 17px" Width="282px" />
        <br />
        <br />
        <br />
        <br />
...
<TR>
<TH colspan ="2" style="color: green; font-size: 12pt">ANTILOPE</TH>
